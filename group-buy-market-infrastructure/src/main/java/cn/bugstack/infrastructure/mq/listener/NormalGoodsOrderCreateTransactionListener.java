...
public class NormalGoodsOrderCreateTransactionListener implements RocketMQLocalTransactionListener {
    ...
    public RocketMQLocalTransactionState executeLocalTransaction(Message message, Object arg) {
        ...
        try {
            aggregate = (NormalGoodsOrderAggregate) arg;
    ...
    public RocketMQLocalTransactionState checkLocalTransaction(Message message) {
        ...
        try {
            ...
            NormalGoodsOrderAggregate aggregate = JSON.parseObject(payload, NormalGoodsOrderAggregate.class);
            ...
            log.error("普通商品-事务回查异常，返回UNKNOWN稍后重试: orderId={}, error={}", orderId, e.getMessage(), e);
