-- HotKey Dashboard 数据库初始化脚本
-- 使用方法：mysql -u root -p123456 < init-hotkey-db.sql

CREATE DATABASE IF NOT EXISTS hotkey_db DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
USE hotkey_db;
...
INSERT INTO `hk_user` VALUES (1, 'admin', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '1888888', 'ADMIN', '', NOW(), 1);

-- group-buy-market 应用用户: gbm / 123456
INSERT INTO `hk_user` VALUES (2, 'gbm', 'gbm', 'e10adc3949ba59abbe56e057f20f883e', '1888888', 'APPADMIN', 'group-buy-market', NOW(), 1);
...
-- 预置热点规则：商品热点探测规则
-- 规则说明：以 goods__ 开头的 key，2秒内访问超过10次即为热点，本地缓存60秒
INSERT INTO `hk_rules` VALUES (1, '[{"key":"goods__","prefix":true,"interval":2,"threshold":10,"duration":60}]', 'group-buy-market', 'admin', NOW(), 1);
...
CREATE TABLE `biz_access_token` (
   `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
   `token` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT 'token',
   `flag` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT '' COMMENT 'flag',
    `CREATED_BY` varchar(128) CHARACTER SET utf8mb4 NULL COMMENT '创建人',
    `CREATED_TIME` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
    `UPDATED_BY` varchar(128) CHARACTER SET utf8mb4 NULL COMMENT '修改人',
    `UPDATED_TIME` datetime NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
     PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'token表' ROW_FORMAT = Compact;
